...
namespace Agenda.Infra.Padronizar.Texto
{
    ...
    public static class TratamentoTexto
    {
        ...
        public static string Base64ToString(this string texto) =>
            Encoding.UTF8.GetString(Convert.FromBase64String(texto ?? ""));
        ...
        public static string VarcharSQL(this string texto)
            => (texto ?? "").Replace("'", ".")
            .Trim();
        ...
        public static string NormalizarTexto(this string texto) // add 06/12/2024
        {
        ...
        public static string RemoverAcentos(this string texto)
        {
            ...
            // Normaliza a string para decompor caracteres acentuados em base + acento
            ...
            foreach (var c in normalized)
            {
                ...
                if (unicodeCategory != UnicodeCategory.NonSpacingMark) // ignora acentos
                {
                    sb.Append(c);
                }
            }
