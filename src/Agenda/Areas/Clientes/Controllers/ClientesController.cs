using Agenda.Aplicacao.Entidades.Clientes;
...
namespace Agenda.Areas.Clientes.Controllers
{
    [Authorize]
    [Area("Clientes")]
    public class ClientesController : BasicController
    {
        ...
        public async Task<JsonResult> AlterarClientes([FromForm] Cliente dados)
        {
            try
            {
                if (dados == null)
                ...
                using var app = new ClientesAppServicos(base.UserIdentity, base.Configuration, base.Identidade);
